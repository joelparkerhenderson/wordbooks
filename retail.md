...
* [flying squad](TODO):  A group of employees who are not assigned to any specific department, but work wherever they are needed. 
...
* [leased department](TODO):  a part of a department store that is actually leased out to another company; common with cosmetics. 
...
* [link sales](TODO): placing a product next to another to create a spark or encourage the customer to buy more than one product.
* [logical adjacencies](TODO):  like link sales but the layout follows a logical sequence e.g. the way a customer would use the product.
...
* [swing area]: the positioning of tables, gondalas or floor fixtures to influence the flow or direction your customer takes through your environment.
